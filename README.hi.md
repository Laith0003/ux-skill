...
> **AI कोडिंग के लिए सबसे मज़बूत UX प्लगइन।** 11 क्वेरी-योग्य JSON मैनिफ़ेस्ट के साथ एक Python रीज़निंग कोर (84 शैलियाँ, 176 पैलेट, 70 टाइप पेयरिंग, 148 कंपोनेंट, 184 इंडस्ट्री, 35 चार्ट प्रकार, 57 मोशन प्रीसेट, 112 UX नियम, 145 एंटी-पैटर्न नियम, 25 टेक स्टैक, 131 ब्रांड स्पेक), 22 स्लैश कमांड, 5 सब-एजेंट, और एक डिटरमिनिस्टिक एंटी-AI-स्लॉप लिंटर। क्रॉस-IDE: Claude Code, Cursor, Windsurf, GitHub Copilot, Gemini CLI, Codex, Kiro, Cline, Continue, Aider, Zed, JetBrains AI, Pieces, Tabby, Tabnine, CodeWhisperer, और Roo Cline में उपलब्ध।
...
8. [131 ब्रांड DESIGN.md स्पेक — श्रेणी के अनुसार](#131-ब्रांड-designmd-स्पेक--श्रेणी-के-अनुसार)
...
| **Laith0003/ux-skill (ux-skill)** | **14** | **Python इंजन + 11 मैनिफ़ेस्ट + 22 कमांड + 5 सब-एजेंट + CI लिंटर** | **22** | **145 regex नियम** | **131** | **148** | **57** | **17** |
...
- **ब्रांड स्पेक:** 131 असली DESIGN.md स्पेक (Apple, Stripe, Linear, Figma, Tesla, BMW, Notion, Spotify, Airbnb, Vercel, Supabase, Cursor, Raycast, Claude, और 117 और)। अन्य में से कोई भी ब्रांड लाइब्रेरी नहीं भेजता।
...
│   └── brands/*.json                  131 ब्रांड DESIGN स्पेक + _index.json
│
...
### `brands/*.json` — 131 ब्रांड स्पेक

| फ़ील्ड | विवरण |
|---|---|
| `entries` | 131 (साथ ही सभी को सूचीबद्ध करने वाला `_index.json`) |
...
पूरी सूची [131 ब्रांड DESIGN.md स्पेक](#131-ब्रांड-designmd-स्पेक--श्रेणी-के-अनुसार) में।
...
## 131 ब्रांड DESIGN.md स्पेक — श्रेणी के अनुसार
...
| ब्रांड स्पेक | **131** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
