...
check_system validates and gates a set the engine did not generate (an
edited or imported one) and returns what it found instead of raising.
...
from engine.foundations.build import (
    FOUNDATIONS, BuildResult, SystemCheck, ValidationError, build_color, build_system,
    check_system)
...
__all__ = [
    ...
    "PAIRINGS", "Pairing", "Problem", "SEMANTIC", "SystemCheck", "Token", "TokenSet",
    "ValidationError", "alias_target", "build_color", "build_system", "check_system",
    "dump_dtcg", "from_dtcg", "generate_color",
