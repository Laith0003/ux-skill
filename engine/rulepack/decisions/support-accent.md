...
The support ramp's seed sits at OKLCH lightness 0.6 and the brand's chroma (0.06 to 0.16), at a hue 30 degrees from the brand for a muted brand up to 180 degrees for a bold one, pulled toward warm or cool with the warmth axis. It feeds color.text.support, color.decorative.support and the generated art.
