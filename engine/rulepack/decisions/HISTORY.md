...
- [The host AI passes what an unread word means as axis nudges](character-nudges.md)
...
- [A landing page spaces its sections with its own gap, 128 to 192px at desktop by density](landing-gap.md)
...
- [The brand reaches surfaces as a tint, a band or one brand band, and each stands apart from the page](surfaces-stand-apart.md)
...
- [Code blocks and tables have their own surfaces, and the light code surface is a clean well](clean-code-surface.md)
- [The axes choose each face from a catalog by distance, never by keyword](face-choice.md)
- [The axes choose each face by distance, and the product type adds how bookish a face should be](faces-by-product-type.md)
- [The figure style reads at the page title's size, so it holds a number band](figure-holds-a-number-band.md)
...
- [A client's own identity wins over the generic bans, even without a full design system](client-identity-wins.md)
