---
name: ux-recommend
description: The v2 flagship. Runs the 5-parallel-search Python engine across 11 data manifests (75+ styles, 170+ palettes, 65+ type pairs, 120+ components, 170+ industries, 110+ UX laws, 50+ motion presets, 85+ anti-patterns, 92 brand specs) and returns a complete recommended design system for your project — with always-on anti-slop guardrails.
...
print(len(rec.guardrails))         # 85+ anti-patterns always on
```
...
- `guardrails` — all 85+ anti-patterns (always-on)
