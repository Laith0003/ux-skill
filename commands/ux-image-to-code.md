...
2. Run `/ux-design --extract-only --from-image $ARGUMENTS`. Follow `commands/ux-design.md` in image mode, extraction only, with the same arguments, exactly as if the user had typed the new command.
