...
5. [22 สแลชคอมมานด์ — การอ้างอิงโดยละเอียด](#22-สแลชคอมมานด์--การอ้างอิงโดยละเอียด)
6. [5 ซับเอเจนต์](#5-ซับเอเจนต์)
7. [11 แมนิเฟสต์ข้อมูล](#11-แมนิเฟสต์ข้อมูล)
8. [145 กฎต้านสลอป AI — ลินเตอร์](#145-กฎต้านสลอป-ai--ลินเตอร์)
...
**ux-skill** · **v3.0.0-stable** · สร้างเพื่อให้ Claude Code, Cursor, Windsurf และเครื่องมือเขียนโค้ดด้วย AI ทุกตัวอื่นๆ ส่งออกฟรอนต์เอนด์ที่ไม่อ่านเหมือน AI สร้าง
