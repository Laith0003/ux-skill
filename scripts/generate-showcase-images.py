...
def gen_claude_code_screenshot() -> None:
    ...
    lines = [
        ...
        ("", None, "", None),
        ("→ ", ACCENT_MAGENTA, "Guardrails:  120 anti-pattern rules active", INK_WHITE),
        ("", None, "", None),
        ...
        ("", None, "Linting against 120 anti-pattern rules…", MUTED),
...
def gen_terminal_recommend() -> None:
    ...
    lines = [
        ...
        ("", None, "", None),
        ("✓ ", ACCENT_GREEN, "guardrails active: 120 anti-pattern rules", INK_WHITE),
        ("✓ ", ACCENT_GREEN, "written to .ux/last-recommendation.json", INK_WHITE),
        ("", None, "", None),
        ("$ ", ACCENT_CYAN, "_", INK_WHITE),
    ]
