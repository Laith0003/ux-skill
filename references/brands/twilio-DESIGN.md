...
Functional developer-grade motion — code-snippet tabs have a 150ms underline slide. API request/response chrome animates with a slight type-in effect on landing. The brand reads as devtools-functional.
