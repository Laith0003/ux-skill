...
## Motion signature
Hero auto-plays muted clip — typically 30 seconds of a featured show with slow camera moves and atmospheric music. The signature 'TUDUM' sonic mnemonic — the brand's audio motif — plays on app cold-start.
