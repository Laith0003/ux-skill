...
Editorial fade-in reveals on scroll (250ms ease-out). Carousel cross-fade at 1.2–1.5s — deliberately slow. The motion philosophy matches the prestige restraint.
