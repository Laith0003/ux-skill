# Design System Inspired by DuckDuckGo
...
**Do.** Use friendly approachable privacy language ("Privacy, simplified", "We don't track you"). Reference everyday contexts. Use sentence case for chrome.

**Don't.** Don't use scare-tactic copy. Don't sanitize Dax the duck. Don't write enterprise-formal microcopy.

## 7. Motion Vocabulary

Friendly micro-animations — Dax may wave or blink on hero pages. Cards lift on hover (1.02 scale, 200ms ease). Search bar focus animates with a soft expand. The motion is friendly-confident.

## 8. Anti-patterns to Avoid

- **Don't replace Dax the duck with a generic icon.** The mascot is brand voice
- **Don't tint DuckDuckGo Red-Orange.** The specific saturated hex is brand
- **Don't sharpen card radii below 8px.** Friendly privacy is the brand
- **Don't drop the search-bar-as-hero on the home page.** It is brand IA
- **Don't pair the chrome with a saturated tech-blue accent.** The orange is the voltage
- **Don't write contrarian privacy copy.** DuckDuckGo's brand is friendly, not contrarian
