...
Characters have idle animations on landing pages — Astro might blink, float gently, or wave. Mega-menu drops with a 250ms ease-out. The character animations are signature; reducing them to static illustration flattens the brand.
